...
(1, 'demo@expensemanager.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Demo User');
...
-- Sample transactions across various categories
...
(1, 2, 35.00, 'USD', 'Netflix', 'Subscriptions', '2026-01-08', 'Annual plan monthly'),
...
(1, 2, 22.00, 'USD', 'Spotify', 'Subscriptions', '2026-01-13', 'Music subscription'),
...
(1, 1, 67.00, 'USD', 'Trader Joes', 'Food & Groceries', '2026-02-12', 'Groceries'),
(1, 2, 15.99, 'USD', 'Hulu', 'Subscriptions', '2026-01-21', 'Streaming'),
...
(1, 2, 25.00, 'USD', 'AMC Theaters', 'Entertainment', '2026-01-28', 'Movie night'),
...
(1, 2, 99.99, 'USD', 'Adobe', 'Subscriptions', '2026-02-02', 'Creative Cloud'),
...
(1, 1, 450.00, 'USD', 'Chase Bank', 'EMI', '2026-02-05', 'Car loan payment'),
(1, 1, 500.00, 'USD', 'Vanguard', 'Investments', '2026-02-10', 'Monthly index fund'),
(1, 1, 200.00, 'USD', 'Savings Transfer', 'Savings', '2026-02-11', 'Emergency fund transfer');
...
(1, 'Entertainment', 1, 2026, 100.00),
(1, 'Shopping', 1, 2026, 300.00),
(1, 'Utilities', 1, 2026, 250.00),
(1, 'Healthcare', 1, 2026, 500.00),
(1, 'Housing', 1, 2026, 1500.00),
(1, 'Subscriptions', 1, 2026, 200.00),
(1, 'EMI', 1, 2026, 500.00),
(1, 'Savings', 1, 2026, 1000.00),
(1, 'Investments', 1, 2026, 500.00);
...
-- Ensure users.id sequence is at or above the max id (1)
